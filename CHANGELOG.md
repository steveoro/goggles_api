...
- **0.3.46** [Steve A.] minor bundle security fixes; re-sync with the base engine; added CRUD endpoints for /calendars (admin-only) & ID value override in POST /season;
