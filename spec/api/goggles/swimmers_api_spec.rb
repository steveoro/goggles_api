...
RSpec.describe Goggles::SwimmersAPI do
  ...
  describe 'GET /api/v3/swimmer/:id' do
    ...
    context 'when requesting a non-existing ID,' do
      before do
        ...
        get(api_v3_swimmer_path(id: 0), headers: fixture_headers)
      end
  ...
  describe 'PUT /api/v3/swimmer/:id' do
    ...
    context 'when requesting a non-existing ID,' do
      before do
        expect(GogglesDb::Swimmer.exists?(0)).to be false
        put(api_v3_swimmer_path(id: 0), params: expected_changes, headers: crud_headers)
      end
  ...
  describe 'GET /api/v3/swimmers/' do
    ...
    context 'when filtering by a non-existing value,' do
      before do
        ...
        get(api_v3_swimmers_path, params: { gender_type_id: 0 }, headers: fixture_headers)
      end
