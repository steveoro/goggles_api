    ...
    resource :meeting_individual_result do
      ...
      route_param :id do
        get do
          ...
          GogglesDb::MeetingIndividualResult.find_by_id(params['id'])
        end
      end
      ...
      params do
        ...
        optional :play_off, type: Boolean, desc: 'optional: true if this result refers to a play-off at the end or after the end of a season (standard play otherwise)'
        ...
        optional :meeting_individual_points, type: Float, desc: 'optional: result score computed with meeting-specific rules'
      ...
      route_param :id do
        put do
          ...
          meeting_individual_result = GogglesDb::MeetingIndividualResult.find_by_id(params['id'])
