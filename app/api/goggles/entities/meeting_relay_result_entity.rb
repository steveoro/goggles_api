...
module Goggles
  module Entities
    # Entity for MeetingRelayResult endpoints.
    class MeetingRelayResultEntity < BaseEntity
      expose :id, documentation: { type: 'Integer', desc: 'MeetingRelayResult ID' }
      ...
      expose :relay_code, documentation: { type: 'String', desc: 'Descriptive code for multiple relays from same team' }
      expose :entry_time_type_id, documentation: { type: 'Integer', desc: 'EntryTimeType ID for relay entry' }
      expose :entry_minutes, documentation: { type: 'Integer', desc: 'Entry time minutes' }
      expose :entry_seconds, documentation: { type: 'Integer', desc: 'Entry time seconds' }
      expose :entry_hundredths, documentation: { type: 'Integer', desc: 'Entry time hundredths of seconds' }
      ...
      expose :disqualified, documentation: { type: 'Boolean', desc: 'True if team relay has been disqualified' }
      ...
      expose :meeting_relay_swimmers_count, documentation: { type: 'Integer', desc: 'Count of relay swimmers' }
